...
| ArgoCD                 | [argocd.${APPLICATIONS.GLOBAL.BASE_URL}](https://argocd.${APPLICATIONS.GLOBAL.BASE_URL}) |
| Argo Workflows         | [workflows.${APPLICATIONS.GLOBAL.BASE_URL}](https://workflows.${APPLICATIONS.GLOBAL.BASE_URL}) |
| Docker Registry UI     | [docker.${APPLICATIONS.GLOBAL.BASE_URL}](https://docker.${APPLICATIONS.GLOBAL.BASE_URL}) |
| Gitea                  | [gitea.${APPLICATIONS.GLOBAL.BASE_URL}](https://gitea.${APPLICATIONS.GLOBAL.BASE_URL}) |
...
| Kubernetes Dashboard   | [dashboard.${APPLICATIONS.GLOBAL.BASE_URL}](https://dashboard.${APPLICATIONS.GLOBAL.BASE_URL}) |
| NATS                   | [nats.${APPLICATIONS.GLOBAL.BASE_URL}](https://nats.${APPLICATIONS.GLOBAL.BASE_URL}) |
| PGAdmin                | [pgadmin.${APPLICATIONS.GLOBAL.BASE_URL}](https://pgadmin.${APPLICATIONS.GLOBAL.BASE_URL}) |
